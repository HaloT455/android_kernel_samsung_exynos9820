...
struct boost_groups { int boost_max; u64 boost_ts; };
static u64 sched_clock_cpu(int cpu) { return 1; }
static bool schedtune_boost_timeout(u64 now, u64 ts) { return false; }
